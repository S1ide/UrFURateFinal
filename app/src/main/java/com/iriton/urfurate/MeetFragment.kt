    ...
    override fun onCreateView(
        ...
        events = mutableListOf(
                Event("Собрание с ректором", "13:00", "14:30", R.drawable.background_urfu,R.drawable.logo_urfu,
                    2020, 5, 1), Event("Мафия", "13:00", "14:30", R.drawable.background_urfu , R.drawable.logo_rtf,2020,
        5, 8), Event("Турнир по шахматам", "15:00", "16:30", R.drawable.background_urfu, R.drawable.logo_hti, 2020,
        5, 11), Event("Онлайн-хакатон", "16:30", "18:30", R.drawable.background_urfu,R.drawable.logo_fti, 2020,
        5, 16), Event("Культурный вечер", "12:00", "13:30", R.drawable.background_urfu, R.drawable.logo_isa, 2020,
        5, 19), Event("Здоровый день", "15:00", "17:30", R.drawable.background_urfu, R.drawable.logo_ifksimp, 2020,
        5, 13), Event("Пикник", "16:00", "19:30", R.drawable.background_urfu, R.drawable.logo_info, 2020,
        5, 14), Event("Турнир по Dota 2", "19:30", "20:30", R.drawable.background_urfu, R.drawable.logo_ienim, 2020,
        5, 19), Event("Лекция от СБЕРБАНКа", "12:00", "13:30", R.drawable.background_urfu, R.drawable.logo_igup, 2020,
        5, 5), Event("Мастер-класс", "18:00", "20:30", R.drawable.background_urfu, R.drawable.logo_ineu, 2020,
        5, 9), Event("Клуб гуманитариев", "09:00", "11:30", R.drawable.background_urfu, R.drawable.logo_ugi, 2020,
        5, 30), Event("Онлайн-марафон", "14:00", "14:30", R.drawable.background_urfu, R.drawable.logo_inmit, 2020,
        5, 15), Event("Как выжить", "13:00", "15:30", R.drawable.background_urfu, R.drawable.logo_uenin, 2020,
        5, 7)) // Создание меропритий
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        calendarView.setOnDayClickListener(object : // Нажатие на день календаря
            ...
            override fun onDayClick(eventDay: EventDay) {
                ...
                var newAdapter = MeetAdapter(ourEvents, object : MeetAdapter.Callback{
                    override fun onItemClicked(item: Event) {
